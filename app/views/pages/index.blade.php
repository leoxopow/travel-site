                ...
                <div class="row">
                    <article class="col-md-3 article">
                        <div class="card">
                            ...
                            <a href="#" class="category-label" style="background-color: #6741dc; color: #6741dc; border: 1px solid #6741dc"><span>Style</span></a>
                        </div>
                    </article>
                    <article class="col-md-6 col-xs-12 article column2">
                        <div class="card">
                            ...
                            <a href="#" class="category-label" style="background-color: #d8a252; color: #d8a252; border: 1px solid #d8a252"><span>Social life</span></a>
                        </div>
                    </article>
                    <article class="col-md-3 article">
                    ...
                    <article class="col-md-3 article">
                        <div class="card">
                            ...
                            <a href="#" class="category-label" style="background-color:  #41a674; color: #41a674; border: 1px solid #41a674"><span>Nature</span></a>
                        </div>
                    </article>
                    <article class="col-md-3 article">
                        <div class="card">
                    ...
                    <article class="col-md-3 article">
                        <div class="card">
                            ...
                            <a href="#" class="category-label" style="background-color:  #41a674; color: #41a674; border: 1px solid #41a674"><span>SOCIAL LIFE</span></a>
                        </div>
                    </article>
                </div>
            </div>
            <section class="container-fluid">
                <div class="row">
                    <article class="promo-post">
                        <img src="{{asset('app/images/big_post.jpg')}}" class="promo-thumb" alt="" >
                        <div class="info">
